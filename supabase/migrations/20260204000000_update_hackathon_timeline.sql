...
DELETE FROM public.portfolio_timeline WHERE title = 'Hackathon Winner' AND year = '2023';

-- Update display order for existing entries
UPDATE public.portfolio_timeline SET display_order = 5 WHERE title = 'AI Research Intern' AND year = '2024';
UPDATE public.portfolio_timeline SET display_order = 6 WHERE title = 'Open Source Contributor' AND year = '2023';
UPDATE public.portfolio_timeline SET display_order = 7 WHERE title = 'Started B.Tech' AND year = '2022';
UPDATE public.portfolio_timeline SET display_order = 8 WHERE title = 'First ML Project' AND year = '2022';

-- Insert new hackathon achievements for 2025
